...
Proyek ini dibuat untuk memenuhi penugasan praktikum Pemrograman Berorientasi Objek (PBO). Fokus utama penugasan adalah implementasi konsep dasar OOP Java—khususnya penggunaan **Atribut**, **Constructor**, serta method **Setter & Getter** pada setiap class, serta pemanggilan seluruh objek ke dalam Main Class (`Bunga.java`).

Pengerjaan proyek menerapkan prinsip kolaborasi Git dan GitHub, di mana masing-masing anggota kelompok bertanggung jawab mengunggah satu berkas class bunga secara mandiri.
